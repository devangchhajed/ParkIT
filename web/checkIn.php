        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Check-In (Remaining Space: <?php echo $gen_count ?>)</h3>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <?php
                    ...
                    $row = mysqli_fetch_assoc($result);
                    $pid = $row['parking_lot_id'];
                    $sql = "SELECT user_id from bookings WHERE check_in_time is NULL and parking_lot_id = ".$pid;
                    $result = $conn->query($sql);
                    if($result->num_rows>0){
                      ...
                      ?>
                          ...
                          <form method="POST" action="checkInn.php">
                        <tr>
                      <th scope="row">
