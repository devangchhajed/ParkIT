...
public class SessionManager {
    ...
    private static final String KEY_CARNUMBER = "carnumber";
    ...
    public void setLogin(boolean isLoggedIn, String id, String name, String phone, String carnumber) {

        editor.putBoolean(KEY_IS_LOGGEDIN, isLoggedIn);
        editor.putString(KEY_ID, id);
        editor.putString(KEY_NAME, name);
        editor.putString(KEY_PHONE, phone);
        editor.putString(KEY_CARNUMBER, carnumber);
        editor.putBoolean(KEY_BOOKED, false);
    ...
    public void setBooked(Boolean loc) {
        editor.putBoolean(KEY_BOOKED, loc);
        editor.commit();
    }
    ...
    public String getCar(){
        return (String) pref.getString(KEY_CARNUMBER, "0");
    }
}